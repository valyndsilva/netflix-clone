...
function Feature() {
  ...
  return (
    <div
      className="flex flex-col w-full pt-28 pb-80 bg-cover bg-no-repeat bg-center relative z-10"
    ...
    >
      ...
      <div className="flex flex-col my-3 md:my-0 h-14 py-36 px-0 mt-5 justify-between z-30">
        <div className=" md:w-[36vw] mx-14">
          <h2 className="text-white md:h-20 leading-normal text-2xl md:text-5xl m-0 mb-5">
            {truncate(featureItem?.title, 20)}
          </h2>
          <p
            className="text-white md:h-12 leading-normal text-lg md:text-md m-0"
